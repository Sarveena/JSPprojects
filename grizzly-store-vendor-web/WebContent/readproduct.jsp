...
<body>
	...
	<%
		String newVal1 = "";
			...
			rs = stmt.executeQuery(
					"select vendor_name,vendor_rating,vendor_contact,vendor_adrs,vendor_id from vendor,vendor_profile where vendor.username=vendor_profile.vendor_name and vendor_profile.vendor_name='"
	...
	<div class="a3">
		...
		<h6 align="center" style="font-family: Georgia">
			Rating<%=newVal2%></h6>
		<h6 align="center" style="font-family: Georgia">ID</h6>
		<h6 align="center" style="font-family: Georgia"><%=newVal5%></h6>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-4 " id="a10">
					<form method="get" action="readproduct.jsp">
				...
				<div class="col-sm-6 col-md-4" id="c1">
					<a href="inventory.jsp"><button type="submit"
							class="btn btn-tertiary btn-lg btn-block" id="x2"
			...
			<table class="table table-bordered" id="a9">
				...
				<%
					String val1 = "";
							...
							rs1 = stmt.executeQuery(
									"select product.product_name,brand.brand_name,product.product_category, brand.rating,product.product_id,brand_new.offer from product,brand,vendor_profile,brand_new where product.product_id=brand.product_id and  vendor_profile.vendor_name=product.admin_name and product.admin_name='"
											+ ses.getAttribute("username").toString() + "'");
				...
				<tbody>
					<tr>
						...
						</a> <a href="delete.jsp?product_id=<%=val5%>"><button
									type="submit" class="btn btn-light" id="a18">Remove</button></a></td>
