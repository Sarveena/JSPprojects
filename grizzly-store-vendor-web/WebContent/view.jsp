	...
	<form action="editprofileAction.jsp">
		<%
			...
			try {
				...
				VendorBean profile = profileDAO.read(request.getParameter("admin_name"));
		...
		<%
			String newVal1 = "";
				...
				rs1 = stmt1.executeQuery(
						"select product_desc,product_name from product,profile where product.product_id = profile.admin_id ");
				...
				ResultSet rs2 = null;
				rs2 = stmt2
						.executeQuery("select brand_name from brand,product where product.product_id=brand.product_id");
				String v3 = "";
		...
		<div class="p-3 mb-2 bg-light text-dark" style="font-size: 20px">
			...
			<a class="btn" id="a20"><i class="fa fa-bell" role="button"
				id="a20"></i></a>&emsp; Welcome
			<%=newVal1%>
			&emsp;&emsp;&emsp; <a href="index.jsp"><button type="submit"
		...
		<div>
			...
			<p style="font-size: 20px">
				<i class="fa fa-star-o"></i>4.7
			</p>
		</div>

		<div class="a21">
			<a class="btn" id="a20"><i class="fa fa-pencil" role="button"
				id="a20"></i></a> </i> <img src="images/product.jpg" class="d-block w-100"
				alt="No Items Found">
		</div>
...
vel illum dolore eu feugiat nulla facilisis at
             ...
             -->
			</br> </br> </br> </br> </br> RS.XXXX/- 15%off <a class="btn" id="a20"><i
				class="fa fa-pencil" role="button" id="a22"></i></a></i>
			</button>
			<pre>               
				<button type="submit" class="btn btn-secondary" id="a23"> <b>Finish</b>
				</button>
				</br>
				<form method="get" action="Secondlogin.html" style="display: inline">                             	<button
						type="submit" class="btn btn-light" id="a24">
						<b>Cancel</b>
				</button>
			</form>
