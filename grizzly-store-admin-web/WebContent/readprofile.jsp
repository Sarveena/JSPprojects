			...
			<div class="row">
				<div class="col-sm-6 col-md-6" id="a10">
					<form method="get" action="productclick.jsp">
						...
						<a href="productclick.jsp">	<button type="submit" style="background-color: darkgray; color: black; box-shadow: 0px 10px gray" id="x2" class="btn btn-tertiary btn-lg btn-block"><h2>PRODUCTS</h2></button></a>
						</button>
					</form>
			...
			<div class="row top-buffer">
				...
				<div class="col-sm-6">
					<form action="addAction.jsp" id="form1">
						...
						<hr/></div><div class="a14"><button type="submit" class="btn btn-secondary" id="a15" form="form1">Add</button>
				</form></br> </br>
