...
//out.println(uname1);
		...
		if (status >= 3) {
			PreparedStatement pstmt = conn.prepareStatement("update grizzly set status=? where username=?");
			pstmt.setString(1, "1");
